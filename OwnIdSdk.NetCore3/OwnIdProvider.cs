...
namespace OwnIdSdk.NetCore3
{
    public class OwnIdProvider
    {
        ...
        public OwnIdProvider(IOwnIdCoreConfiguration ownIdCoreConfiguration, ICacheStore cacheStore,
                ...
                new JwtPayload(null, null, null, DateTime.UtcNow, DateTime.UtcNow.AddHours(1), DateTime.UtcNow)
                {
                    ...
                    {"callback", GenerateCallbackUrl(context)},
                    {
                        "requester", new
                        {
                            ...
                            pubKey = RsaHelper.ExportPublicKeyToPkcsFormattedString(_ownIdCoreConfiguration.JwtSignCredentials),
                            name = _localizationService.GetLocalizedString(_ownIdCoreConfiguration.Name),
                            icon = _ownIdCoreConfiguration.Icon,
                            description = _localizationService.GetLocalizedString(_ownIdCoreConfiguration.Description)
                        }
                    },
                    {
                        // TODO : PROFILE
                        ...
                        {
                            var label = _localizationService.GetLocalizedString(x.Label, true);
                                ...
                                return new
                            {
                                ...
                                key = x.Key,
                                label = label,
                                placeholder = _localizationService.GetLocalizedString(x.Placeholder, true),
