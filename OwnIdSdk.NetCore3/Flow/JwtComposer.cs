...
namespace OwnIdSdk.NetCore3.Flow
{
    ...
    public class JwtComposer : IJwtComposer
    {
        ...
        /// <param name="locale">Optional. Content locale</param>
        /// <returns></returns>
        public string GeneratePinStepJwt(string context, FrontendBehavior nextFrontendBehavior, string pin,
            string locale = null)
        {
        ...
        public string GenerateFinalStepJwt(string context, FrontendBehavior nextFrontendBehavior, string locale = null)
        {
