...
namespace OwnIdSdk.NetCore3.Tests.Cryptography
{
    public class RsaHelperTest
    {
        ...
        {
            using var publicKey = new StringReader(PublicKeyStartString + PublicBase64EncodedKey + PublicKeyEndString);
            using var privateKey = new StringReader(PrivateKeyStartString + PrivateBase64EncodedKey + PrivateKeyEndString);
