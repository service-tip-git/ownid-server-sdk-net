...
namespace OwnIdSdk.NetCore3.Web.Gigya
{
    public static class OwnIdConfigurationBuilderExtension
    {
        ...
        /// </summary>
        /// <param name="dataCenter">Gigya data center servers (us1, eu1 and etc.) If you are not sure of your site's data center, <see cref="https://developers.gigya.com/display/GD/Finding+Your+Data+Center">Finding Your Data Center</see>.</param>
